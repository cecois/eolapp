...
this.CVJEK=this.CVJEK||{},this.CVJEK.templates=this.CVJEK.templates||{},this.CVJEK.templates.postsActiveViewTpl=Handlebars.template({1:function(t,a,n,l){return"active"},compiler:[6,">= 2.0.0-beta.1"],main:function(t,a,n,l){var s,e,i=this.escapeExpression;return'<li data-id="'+i(this.lambda(null!=t?t.slug:t,t))+'" class="'+(null!=(s=a["if"].call(t,null!=t?t.active:t,{name:"if",hash:{},fn:this.program(1,l,0),inverse:this.noop,data:l}))?s:"")+'">\n\t'+i((e=null!=(e=a.content||(null!=t?t.content:t))?e:a.helperMissing,"function"==typeof e?e.call(t,{name:"content",hash:{},data:l}):e))+"\n</li>\n"},useData:!0}),this.CVJEK.templates["postsMenuView-MiniTpl"]=Handlebars.template({1:function(t,a,n,l){var s,e=this.lambda,i=this.escapeExpression;return'<a data-id="'+i(e(null!=t?t.slug:t,t))+'" href="#" class="list-group-item-min text-center '+(null!=(s=a["if"].call(t,null!=t?t.active:t,{name:"if",hash:{},fn:this.program(2,l,0),inverse:this.noop,data:l}))?s:"")+'">\n\t<br/>\n\t'+i(e(null!=t?t.title:t,t))+"\n</a>\n"},2:function(t,a,n,l){return"active"},compiler:[6,">= 2.0.0-beta.1"],main:function(t,a,n,l){var s;return null!=(s=a.each.call(t,null!=t?t.rows:t,{name:"each",hash:{},fn:this.program(1,l,0),inverse:this.noop,data:l}))?s:""},useData:!0}),this.CVJEK.templates.postsMenuViewTpl=Handlebars.template({1:function(t,a,n,l){var s,e=this.lambda,i=this.escapeExpression;return'<a data-id="'+i(e(null!=t?t.slug:t,t))+'" href="#" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 list-group-item text-center '+(null!=(s=a["if"].call(t,null!=t?t.active:t,{name:"if",hash:{},fn:this.program(2,l,0),inverse:this.noop,data:l}))?s:"")+'">\n\t<div class="posts-menu-a-splash-wrapper col-lg-12 col-md-12 col-sm-12 col-xs-12">\n\t<img class="posts-menu-a-splash-img" src="/assets/img/'+i(e(null!=t?t.splash:t,t))+'"></img>\n\t</div>\n\t<br/>\n\t<div class="posts-menu-a-title col-lg-12 col-md-12 col-sm-12 col-xs-12">\n\t'+i(e(null!=t?t.title:t,t))+"\n\t</div>\n</a>\n"},2:function(t,a,n,l){return"active"},compiler:[6,">= 2.0.0-beta.1"],main:function(t,a,n,l){var s;return null!=(s=a.each.call(t,null!=t?t.rows:t,{name:"each",hash:{},fn:this.program(1,l,0),inverse:this.noop,data:l}))?s:""},useData:!0});
...
var State=Backbone.Model.extend({defaults:{q:null,slug:null,panestate:"out",bbox:null,basemap:null,agob:null,gogob:!1},initialize:function(e){return e||(e={}),this.get("gobseens")||this.set({gobseens:new Array}),this.on("change:slug",this.update,this),this.on("change:panestate",this.update,this),this.on("change:bbox",this.update,this),this.on("change:agob",this.up_gob,this),this},up_gob:function(){var e=this.get("gobseens");return e.push(this.previousAttributes().agob),this.set({gobseens:_.unique(e)}),this.update()},update:function(){return appRoute.navigate(this.pullurl()),this},getAgobString:function(){var e=this.get("agobs");return 0==e.length||"undefined"==typeof e?"null":"object"==typeof e?e.join(","):e},pullurl:function(){var e="#"+this.get("slug")+"/"+this.get("panestate")+"/"+this.get("agob")+"/"+this.get("bbox");return e}}),BaseLayer=Backbone.Model.extend({defaults:{active:!1},initialize:function(){}}),Geom=Backbone.Model.extend({}),Post=Backbone.Model.extend({url:function(){return"api/jekyllfetcher.php"},initialize:function(e){return e||(e={}),this}}),UTIL=Backbone.Model.extend({initialize:function(){return this},get_style:function(e,t,o){if("point"==e.toLowerCase())var i=e.toLowerCase();if("poly"==e.toLowerCase())var i=e.toLowerCase();if("multipolygon"==e.toLowerCase())var i="poly";if("polygon"==e.toLowerCase())var i="poly";if("line"==e.toLowerCase())var i=e.toLowerCase();if("multilinestring"==e.toLowerCase())var i="line";if("linestring"==e.toLowerCase())var i="line";var l="#384754",a="#C7E048",r="black",n="#929292",s="#C7E048";switch(i){case"point":if(1==t)var u={radius:18,fillColor:a,color:s,weight:13,opacity:1,fillOpacity:.8};else if(1==o)var u={radius:8,fillColor:l,color:r,weight:10,opacity:.6,fillOpacity:.2};else var u={radius:8,fillColor:l,color:r,weight:10,opacity:1,fillOpacity:.8};break;case"poly":if(1==t)var u={fillColor:a,color:s,weight:13,opacity:1};else if(1==o)var u={fillColor:l,color:r,weight:10,opacity:.2};else var u={fillColor:l,color:l,weight:10,opacity:.8};break;case"line":if(1==t)var u={fillColor:a,color:s,weight:13,opacity:1};else if(1==o)var u={fillColor:r,color:n,weight:10,opacity:1};else var u={fillColor:l,color:l,weight:10,opacity:.8};break;default:var u={fillColor:"gray",color:"gray",weight:3,opacity:.3}}return u}});
var GeomsCollection=Backbone.Collection.extend({model:Geom,url:function(){return"assets/offline/cartodb-query.geojson"},initialize:function(t){return t||(t={}),this},activate:function(){return _.each(this.models,function(t){t.get("cvjekid")==appState.get("agob")&&(t.properties.active=1)}),this},deactivate:function(){return this.invoke("set",{active:!1},{silent:!0}),this.activate()},parse:function(t){_.each(t.features,function(t,e){});return t.features}}),BaseLayersCollection=Backbone.Collection.extend({model:BaseLayer,url:function(){return null},initialize:function(t){t||(t={})}}),PostsCollection=Backbone.Collection.extend({model:Post,url:function(){return null},initialize:function(t){return this.listenTo(appState,"change:slug",this.activate),t||(t={}),this},activate:function(){return this.each(function(t,e){t.set({active:!1},{silent:!0})}),this.actually()},actually:function(t){var e=this.findWhere({slug:appState.get("slug")});return"undefined"!=typeof e&&e.set({active:!0}),this}});
var PostsMenuView=Backbone.View.extend({el:"#posts-menu",template:CVJEK.templates.postsMenuViewTpl,template_min:CVJEK.templates["postsMenuView-MiniTpl"],events:{"click a":"activate"},initialize:function(){return this.listenTo(this.collection,"change:active",this.render),this.listenTo(appState,"change:panestate",this.render),this.render()},log:function(e){e.preventDefault();$(e.currentTarget).attr("data-id");return this},activate:function(e){e.preventDefault();var t=$(e.currentTarget).attr("data-id");return appState.set({slug:t}),this},render:function(){switch(!0){case"down"==appState.get("panestate"):$("#posts-menu").removeClass("col-lg-12 col-md-12 col-sm-12 col-xs-12"),$("#posts-menu").addClass("col-lg-2 col-md-2 col-sm-2 col-xs-2"),$("#posts-menu").addClass("minified");break;case null!==appState.get("slug"):$("#posts-menu").removeClass("col-lg-12 col-md-12 col-sm-12 col-xs-12"),$("#posts-menu").addClass("col-lg-2 col-md-2 col-sm-2 col-xs-2"),$("#posts-menu").addClass("minified");break;default:$("#posts-menu").removeClass("col-lg-2 col-md-2 col-sm-2 col-xs-2"),$("#posts-menu").addClass("col-lg-12 col-md-12 col-sm-12 col-xs-12"),$("#posts-menu").removeClass("minified")}return $(this.el).html(this.template({rows:this.collection.toJSON()})),this}}),BaseLayersView=Backbone.View.extend({id:"map",events:{change:"render"},initialize:function(){window.map=new L.Map(this.id,{zoomControl:!1,center:[42.22852,-99.05273],zoom:4,attributionControl:!1}),map.on("moveend",function(){appState.set({bbox:map.getBounds().toBBoxString()})}),this.collection.bind("change:active",this.render,this),this.render()},render:function(){"undefined"==typeof baseLayer?baseLayer=null:map.removeLayer(baseLayer);var e=this.collection.findWhere({active:!0}).get("definition");return void 0!=e.subdomains?baseLayer=new L.TileLayer(e.url,{subdomains:e.subdomains,maxZoom:18}):baseLayer=new L.TileLayer(e.url,{maxZoom:18}),map.addLayer(baseLayer),baseLayer.bringToBack(),this}}),PostsView=Backbone.View.extend({el:"#active-post-container",template:CVJEK.templates.postsActiveViewTpl,events:{"click .copy-trigger":"activate"},initialize:function(){return this.listenTo(this.collection,"change:active",this.render),this.listenTo(appState,"change:panestate",this.render),this},downout:function(){switch(appState.get("panestate")){case"down":$("#active-container").addClass("collapsed"),$("#paneToggler").addClass("collapsed");break;case"out":$("#active-container").removeClass("collapsed"),$("#paneToggler").removeClass("collapsed");break;default:$("#active-container").removeClass("collapsed")}return this},log:function(e){e.preventDefault();$(e.currentTarget).attr("data-id"),$(e.currentTarget).attr("data-type");return this},activate:function(e){e.preventDefault();var t=$(e.currentTarget).attr("data-id"),a=$(e.currentTarget).attr("data-type");switch(a){case"slug":appState.set({slug:t});break;case"gob":appState.set({agob:t,gogob:!0});break;default:}return this},showhide:function(){return null!==appState.get("slug")?($(this.el).show(),"down"==appState.get("panestate")?$(this.el).addClass("minimized"):$(this.el).removeClass("minimized")):$(this.el).hide(),this},render:function(){var e=this.collection.findWhere({active:!0});e.get("url").substr(1,e.get("url").length);return $(this.el).html(_.unescape(e.get("content"))),this.showhide()}}),GeomsView=Backbone.View.extend({el:null,events:{},initialize:function(){return this.listenTo(this.collection,"sync",this.paint),eolItems=L.geoJson().addTo(map),this.listenTo(appState,"change:agob",this.repaint),this.listenTo(appState,"change:bbox",this.zoomy),this},zoomy:function(){return null!=appState.previousAttributes().bbox&&"undefined"!=typeof appState.previousAttributes().bbox||map.fitBounds(leafletize_Bbox(appState.get("bbox"))),this},asgeojson:function(){return cg=[],this.collection.each(function(e,t){var a=e.get("geometry"),o=e.get("properties"),n=o.cvjek;"undefined"!=typeof appState.get("agob")&&(o.active=appState.get("agob")==n?1:0),appState.get("gobseens")&&"object"==typeof appState.get("gobseens")?o.seen=_.indexOf(appState.get("gobseens"),n)>-1?1:0:o.seen=0,o.exalted=appState.get("agob")==n?1:0;var s=a.type,i={type:"Feature",properties:{name:o.name,cvjekid:n,active:o.active,seen:o.seen,exalted:o.exalted,geom_type:s,anno:o.anno,style:CVJUTIL.get_style(s,o.active,o.seen)},geometry:a};cg.push(i)}),cg},pop:function(){_.each(eolItems.getLayers(),function(e){var t=_.each(e.getLayers(),function(e){return 1==e.feature.properties.active&&(console.info("current feature whose props are active:"),console.log(e.feature.properties),map.fitBounds(e.getBounds()),e.openPopup()),1==e.feature.properties.active});return t});return this},repaint:function(e,t){return eolItems.eachLayer(function(e){e._layers&&_.each(e._layers,function(e){var a=e.feature.properties.cvjekid,o=e.feature.geometry.type;1==appState.get("gogob")&&appState.get("agob")==a&&(e.openPopup(),map.fitBounds(e.getBounds()),map.setZoom(map.getZoom()-2));var n=a==t?1:0,s=_.indexOf(appState.get("gobseens"),a)>=0?1:0;e.setStyle(CVJUTIL.get_style(o,n,s))})}),appState.set({gogob:!1},{silent:!0}),this},paint:function(){function e(e,t){t.on("click",function(e){if(e){console.log("layer.feature yes:");var t=e.target.feature.geometry.type;console.info("gtype"),console.log(t);var a=e.target.feature.properties.cvjekid;console.info("nid"),console.log(a)}a==appState.get("agob")?(console.log("hey this one's already active"),appState.set({agob:null})):appState.set({agob:a})});var a=e.properties.name;e.properties&&e.properties.popupContent&&(a+=e.properties.popupContent),t.bindPopup(a).on("popupclose",function(e){}),t.on("popupopen",function(e){console.info("p in open"),console.log(e),e.target.bringToFront()})}eolItems.clearLayers(),eolItems.clearAllEventListeners();var t=this.asgeojson();return L.geoJson(t,{style:function(e){return e.properties.style},onEachFeature:e}).addTo(eolItems),this.pop()}});