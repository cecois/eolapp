...
this.CVJEK=this.CVJEK||{},this.CVJEK.templates=this.CVJEK.templates||{},this.CVJEK.templates.postsActiveViewTpl=Handlebars.template({1:function(t,a,n,e){return"active"},compiler:[6,">= 2.0.0-beta.1"],main:function(t,a,n,e){var l,i,s=this.escapeExpression;return'<li data-id="'+s(this.lambda(null!=t?t.slug:t,t))+'" class="'+(null!=(l=a["if"].call(t,null!=t?t.active:t,{name:"if",hash:{},fn:this.program(1,e,0),inverse:this.noop,data:e}))?l:"")+'">\n\t'+s((i=null!=(i=a.content||(null!=t?t.content:t))?i:a.helperMissing,"function"==typeof i?i.call(t,{name:"content",hash:{},data:e}):i))+"\n</li>\n"},useData:!0}),this.CVJEK.templates["postsMenuView-MiniTpl"]=Handlebars.template({1:function(t,a,n,e){var l,i=this.lambda,s=this.escapeExpression;return'<a data-id="'+s(i(null!=t?t.slug:t,t))+'" href="#" class="list-group-item-min text-center '+(null!=(l=a["if"].call(t,null!=t?t.active:t,{name:"if",hash:{},fn:this.program(2,e,0),inverse:this.noop,data:e}))?l:"")+'">\n\t<br/>\n\t'+s(i(null!=t?t.title:t,t))+"\n</a>\n"},2:function(t,a,n,e){return"active"},compiler:[6,">= 2.0.0-beta.1"],main:function(t,a,n,e){var l;return null!=(l=a.each.call(t,null!=t?t.rows:t,{name:"each",hash:{},fn:this.program(1,e,0),inverse:this.noop,data:e}))?l:""},useData:!0}),this.CVJEK.templates.postsMenuViewTpl=Handlebars.template({1:function(t,a,n,e){var l,i=this.lambda,s=this.escapeExpression;return'<a data-id="'+s(i(null!=t?t.slug:t,t))+'" href="#" class="list-group-item text-center '+(null!=(l=a["if"].call(t,null!=t?t.active:t,{name:"if",hash:{},fn:this.program(2,e,0),inverse:this.noop,data:e}))?l:"")+'">\n\t<br/>\n\t'+s(i(null!=t?t.title:t,t))+"\n</a>\n"},2:function(t,a,n,e){return"active"},compiler:[6,">= 2.0.0-beta.1"],main:function(t,a,n,e){var l;return null!=(l=a.each.call(t,null!=t?t.rows:t,{name:"each",hash:{},fn:this.program(1,e,0),inverse:this.noop,data:e}))?l:""},useData:!0});
