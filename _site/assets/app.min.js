...
!function(){var n=Handlebars.template,a=Handlebars.templates=Handlebars.templates||{};a.postsActiveViewTpl=n({1:function(n,a,e,t){return"active"},compiler:[6,">= 2.0.0-beta.1"],main:function(n,a,e,t){var l,i,s=this.lambda,r=this.escapeExpression,u="function",o=a.helperMissing,c='<li data-id="'+r(s(null!=n?n.slug:n,n))+'" class="';return l=a["if"].call(n,null!=n?n.active:n,{name:"if",hash:{},fn:this.program(1,t),inverse:this.noop,data:t}),null!=l&&(c+=l),c+'">\n\t'+r((i=null!=(i=a.content||(null!=n?n.content:n))?i:o,typeof i===u?i.call(n,{name:"content",hash:{},data:t}):i))+"\n</li>\n"},useData:!0}),a.postsMenuViewTpl=n({1:function(n,a,e,t){var l,i=this.lambda,s=this.escapeExpression,r=a.helperMissing,u='<a data-id="'+s(i(null!=n?n.slug:n,n))+'" href="#" class="list-group-item text-center ';return l=a["if"].call(n,null!=n?n.active:n,{name:"if",hash:{},fn:this.program(2,t),inverse:this.noop,data:t}),null!=l&&(u+=l),u+=" ",l=(a.groupem||n&&n.groupem||r).call(n,null!=n?n.slug:n,{name:"groupem",hash:{},fn:this.program(4,t),inverse:this.noop,data:t}),null!=l&&(u+=l),u+'">\n\t<br/>\n\t'+s(i(null!=n?n.title:n,n))+"\n</a>\n"},2:function(n,a,e,t){return"active"},4:function(n,a,e,t){return""},compiler:[6,">= 2.0.0-beta.1"],main:function(n,a,e,t){var l;return l=a.each.call(n,null!=n?n.rows:n,{name:"each",hash:{},fn:this.program(1,t),inverse:this.noop,data:t}),null!=l?l:""},useData:!0})}();
